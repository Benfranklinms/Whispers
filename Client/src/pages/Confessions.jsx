      ...
      <div className="px-40 flex flex-1 justify-center py-5">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          ...
          <div className="flex gap-3 p-3 flex-wrap pr-4">
            <div className="flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#f4f0f0] pl-4 pr-4 cursor-pointer">
          ...
          <div className="p-4">
            {confession.length === 0 ? (
              <p className="text-gray-700">No confessions at the moment</p>
            ) : (
              confession.map((item, index) => (
                <div
                  key={index}
                  className="bg-cover bg-center flex flex-col items-stretch justify-end rounded-xl pt-[132px] mb-6 cursor-pointer hover:shadow-lg transition-shadow duration-300 ease-in-out"
                  style={{
                    backgroundImage:
