      ...
      <div className="relative flex min-h-screen flex-col bg-white overflow-x-hidden">
        <div className="flex flex-1 flex-col px-10 py-5">
          ...
          <div className="flex px-4 py-3 justify-center">
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-rose-600 hover:bg-rose-700 text-white text-sm font-bold leading-normal tracking-[0.015em]">
